...
class CloudAlloyDBAdmin extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->version = 'v1';
    $this->serviceName = 'alloydb';

    $this->projects_locations = new CloudAlloyDBAdmin\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_backups = new CloudAlloyDBAdmin\Resource\ProjectsLocationsBackups(
        $this,
        $this->serviceName,
        'backups',
        [
    ...
    $this->projects_locations_clusters = new CloudAlloyDBAdmin\Resource\ProjectsLocationsClusters(
        $this,
        $this->serviceName,
        'clusters',
        [
    ...
    $this->projects_locations_clusters_instances = new CloudAlloyDBAdmin\Resource\ProjectsLocationsClustersInstances(
        $this,
        $this->serviceName,
        'instances',
        [
    ...
    $this->projects_locations_clusters_users = new CloudAlloyDBAdmin\Resource\ProjectsLocationsClustersUsers(
        $this,
        $this->serviceName,
        'users',
        [
    ...
    $this->projects_locations_operations = new CloudAlloyDBAdmin\Resource\ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        [
    ...
    $this->projects_locations_supportedDatabaseFlags = new CloudAlloyDBAdmin\Resource\ProjectsLocationsSupportedDatabaseFlags(
        $this,
        $this->serviceName,
...
class_alias(CloudAlloyDBAdmin::class, 'Google_Service_CloudAlloyDBAdmin');
