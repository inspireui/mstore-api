...
class WorkloadManager extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->version = 'v1';
    $this->serviceName = 'workloadmanager';

    $this->projects_locations = new WorkloadManager\Resource\ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        [
    ...
    $this->projects_locations_operations = new WorkloadManager\Resource\ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        [
...
class_alias(WorkloadManager::class, 'Google_Service_WorkloadManager');
