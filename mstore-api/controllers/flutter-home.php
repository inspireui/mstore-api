...
class FlutterHome extends WP_REST_Controller
{
    ...
    private $supportedLayouts = ["logo", "header_text", "header_search", "featuredVendors", "category", "bannerAnimated", "bannerImage", "blog", "video", "story", "recentView", "fourColumn","threeColumn","twoColumn", "staggered", "saleOff", "card", "listTile", "largeCardHorizontalListItems", "largeCard", "simpleVerticalListItems", "simpleList", "brand", "sliderList", "sliderItem", "geoSearch", "divider", "spacer", "button", "testimonial", "sliderTestimonial", "instagramStory", "tiktokVideos"];
    /**
